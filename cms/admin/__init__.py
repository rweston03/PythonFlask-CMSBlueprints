...
def content(type):
    if requested_type(type):
        ...
        return render_template('templates/admin/content.html', type=type, content=content)
    else:
        abort(404)
...
def create(type):
    if requested_type(type):
        ...
        return render_template('templates/admin/content_form.html', title='Create', types=types, type_name=type)
    else:
        abort(404)
...
def users():
    ...
    return render_template('templates/admin/users.html', title='Users', users=users)


@admin_bp.route('/settings')
def settings():
    settings = Setting.query.all()
    return render_template('templates/admin/settings.html', title='Settings', settings=settings)
...
def edit(id):
    ...
    return render_template('admin/content_form.html', types=types, title='Edit', item_title=content.title,
